<template>
    <section class="my-10  px-4 mx-auto w-full" id="partnerDescription">
        <div class="flex flex-col gap-3 flex-wrap  mx-auto w-full  lg:max-w-3/4">
            <span class="tracking-[1px] font-barlow font-light ">April 2019</span>
            <h1 class="font-bold font-poppins text-4xl leading-[1.4]">Shopware als starker<br/>Partner</h1>
            <div class="font-barlow font-light">
                <p class="mb-5 leading-[1.6]">
            ...
            <div class='flex gap-3 items-center  my-8 '>
                    <span>
                         <a href='' target='_blank' class="cursor-pointer ">
                            <svg xmlns='http://www.w3.org/2000/svg' width='52' height='52' viewBox='0 0 52 52' c>
